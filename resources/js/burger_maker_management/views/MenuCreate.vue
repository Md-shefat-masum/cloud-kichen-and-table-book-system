                ...
                <form @submit.prevent="submit_data($event)" action="" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="d-flex align-items-start gap-1">
                                <input type="file" @change="image_url($event)" name="base_top_image" class="form-control">
                            </div>
                        </div>
                        <div class="col-12">
...
export default {
    ...
    methods: {
        ...
        submit_data: function(event){
            ...
            axios.post('/admin/store-food-menu',form)
                .then(res=>{
