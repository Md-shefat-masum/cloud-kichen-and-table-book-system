...
import router from './burger_maker_management/burger_maker_management_router';
...
const {
    default: store
} = require('./burger_maker_management/store/index');
...
Vue.component('BurgerManagementApp', require('./burger_maker_management/BurgerManagementApp').default);

const app = new Vue({
    el: '#BurgerManagementAppBody',
    router,
    store,
