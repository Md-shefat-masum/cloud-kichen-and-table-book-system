...
@section('contents')
    ...
    <section id="offerslide" class="py-5 border border-top">
        <div class="container">
            <div class="card">
                <div class="card-body">
                                                            ...
                                                            <tr>
                                                                ...
                                                                >
                                                                    <span class="st-Delink st-Delink--preheader" style="color: #ffffff; text-decoration: none;">
                                                                        Receipt from GubCanteen [#1762-2197] Amount paid ৳{{$order->total_amount}}.00 Date paid {{\Carbon\Carbon::parse($order->data)->format('d/m/y, h:i a')}}
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    "
                                                                >
                                                                    Receipt #{{rand(1000,9999)}}-{{$order->id}}-{{rand(1000,9999)}}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="st-Spacer st-Spacer--stacked" colspan="3" height="12" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                >
                                                                                    @if ($order->payment_status == 'paid')
                                                                                        {{\Carbon\Carbon::parse($order->data)->format('d/m/y, h:i A')}}
                                                                                    @else
                                                                                        pending
                                                                                    @endif
                                                                                </td>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                >
                                                                    ...
                                                                    <a style="border: 0; margin: 0; padding: 0; color: #556cd6 !important; text-decoration: none;" href="mailto:support@gubcanteen.com">support@gubcanteen.com</a>.
                                                                </td>
                                                                <td class="st-Spacer st-Spacer--gutter" style="border: 0; margin: 0; padding: 0; font-size: 1px; line-height: 1px; mso-line-height-rule: exactly;" width="64">
                                                                    <div class="st-Spacer st-Spacer--filler">&nbsp;</div>
                                                                </td>
